...
exports.default = function () {
    return {
        createOptionsBuilder: createOptionsBuilder,
        removeData: removeData
    };

    function removeData(el) {
        var breakAtId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'js_results_header';
...
var util = (0, _helpers2.default)();

// arrays and objects, etc.
var selected_store_id = void 0;
var customersById = void 0; // handy for fast customer lookups
var selectedCustomer = void 0; // handy for fast customer lookups

// Elements:
var errorMessage = void 0;
var successMessage = void 0;
var storeDetailsWrap = void 0;
var storeDetails = void 0;
var resultsTableWrap = void 0;
var resultsTable = void 0;
var resultsTableHeading = void 0;
var addCustomerBtn = void 0;
var addCustomerFirstName = void 0;
var addCustomerLastName = void 0;
var editCustomerFirstName = void 0;
var editCustomerLastName = void 0;
var editCustomerStatus = void 0;
var addCustomerSaveBtn = void 0;
var deleteCustomerBtn = void 0;
var editCustomerModalContent = void 0;
var saveCustomerChangesBtn = void 0;
...
function run() {
    ...
    var _localStorage = localStorage,
        selectedCountry = _localStorage.selectedCountry,
        selectedCity = _localStorage.selectedCity;
...
function getCustomers() {
    ...
    $.get('http://challenge.dev/api/customers/' + selected_store_id).then(function (resp) {
        if (resp.status === 200) {

            // save a quick customer data lookup to use elsewhere
            customersById = resp.data.reduce(function (carry, customer) {
            ...
            var rentalCells = document.querySelectorAll('.rentalCountCell');
            var editIcons = document.querySelectorAll('.js_edit_customer_icn');
            var deleteIcons = document.querySelectorAll('.js_delete_customer_icn');
            rentalCells.forEach(function (cell) {
                return cell.addEventListener('click', afterRentalCellClicked);
            });
            editIcons.forEach(function (cell) {
                return cell.addEventListener('click', afterEditIconClicked);
            });
            deleteIcons.forEach(function (cell) {
                return cell.addEventListener('click', afterDeleteIconClicked);
            });
        }
    });
}
...
function buildResultsTable(data) {
    ...
    data.forEach(function (customer) {
        ...
        var statusClass = active === '1' ? 'glyphicon glyphicon-ok-sign green' : 'glyphicon glyphicon-remove-sign red';
    ...
    var msg = data.length === 1 ? data.length + ' Customer Found' : data.length + ' Customers Found';
...
function afterRentalCellClicked(evt) {
    ...
    var customerID = evt.currentTarget.getAttribute('data-customer');
    selectedCustomer = customersById[customerID];
    var rentalListToShow = selectedCustomer.rentals;
    // grab the modal so we can place our content
    var modalContent = document.getElementById('rental_list_modal_content');
    ...
    if (rentalListToShow.length > 0) {
        rentalListToShow.forEach(function (rental) {
...
function createCustomer(evt) {
    var first_name = document.getElementById('js_add_customer_first_name').value;
    var last_name = document.getElementById('js_add_customer_last_name').value;

    $.post("http://challenge.dev/api/customers", { first_name: first_name, last_name: last_name, store_id: selected_store_id }).then(function (resp) {
        if (resp.status === 201) {
...
function editCustomer(evt) {
    var editFirstNameValue = document.getElementById('js_edit_customer_first_name').value;
    var editLastNameValue = document.getElementById('js_edit_customer_last_name').value;
    var editActiveValue = document.getElementById('js_edit_customer_status').value;
...
function canSaveCustomer() {
    var addCustomerFirstName = document.getElementById('js_add_customer_first_name');
    var addCustomerLastName = document.getElementById('js_add_customer_last_name');

    return addCustomerFirstName.value.length > 0 && addCustomerLastName.value.length > 0;
}

function canEditCustomer() {
    var editCustomerFirstName = document.getElementById('js_edit_customer_first_name');
    var editCustomerLastName = document.getElementById('js_edit_customer_last_name');
...
// important stuff
var cityHistory = {}; // keep a history of our retrieved cities.
var locationsHistory = {}; // keep a history of our retrieved locations.
var selectedLocation = {};
var addCountryOptions = void 0; // function to update options
var addCityOptions = void 0; // function to update options
var countriesById = {};
var citiesById = {};
...
function getCountries() {
    ...
    $.get("http://challenge.dev/api/countries").then(function (resp) {
        if (resp.status === 200) {
            // we require this lookup to properly set selected country
            countriesById = resp.data.reduce(function (carry, data) {
...
function getStoreLocations(city_id) {
    ...
    if (locationsHistory[city_id]) {
        ...
        $.get('http://challenge.dev/api/addresses/' + city_id).then(function (resp) {
...
function buildResultsTable(data) {
    ...
    data.forEach(function (location) {
        var store_id = location.store_id,
    ...
    var msg = data.length === 1 ? data.length + ' Store Found' : data.length + ' Stores Found';
...
var _customers = __webpack_require__(10);
...
$(document).ready(function () {
  ...
  var page_id = document.getElementById('page_id').getAttribute('data-module');

  var modules = {
    home: _main2.default,
    about: _main2.default,
    stores_index: _stores2.default,
    store_customers: _customers2.default
  };
